          ...
          <div className="p-6 md:p-12 max-w-2xl mx-auto space-y-8">
            ...
            <Card className="p-6 bg-white/5 border-white/10 space-y-6">
              ...
              <div className="pt-6 border-t border-white/5 space-y-3">
                <h2 className="text-lg font-semibold"># Corrigir ativação de revendedor pendente</h2>
                <div className="p-4 bg-blue-500/10 border border-blue-500/20 rounded-lg">
                  <h4 className="text-blue-400 font-bold mb-2 flex items-center gap-2">
                    <ShieldCheck className="h-4 w-4" /> Caso pendente: dvdrviatorrent@gmail.com
                  </h4>
                  <p className="text-[10px] text-blue-200/70 leading-relaxed whitespace-pre-wrap">
                    {"Usuário afetado:\n\nEmail: [dvdrviatorrent@gmail.com](mailto:dvdrviatorrent@gmail.com)\n\nProblema identificado:\n\nO usuário realizou a compra para se tornar revendedor. O sistema adicionou os créditos corretamente, porém a conta não foi atualizada para o status de **painel de revendedor ativo**.\n\nPor isso ele consegue ter os créditos, mas não possui as permissões necessárias para cadastrar servidores, causando o erro:\n\n`new row violates row-level security policy for table \"servers\"`\n\nVerificar e corrigir:\n\n* Ativar o status de revendedor dessa conta.\n* Confirmar que o plano/permissão de revendedor está vinculado ao usuário.\n* Garantir que o campo de painel ativo esteja atualizado.\n* Reprocessar a ativação caso o pagamento já esteja confirmado.\n* Validar se o usuário consegue cadastrar servidor após a correção.\n\nTambém verificar se existem outros usuários na mesma situação:\n\n* Pagamento aprovado;\n* Créditos adicionados;\n* Porém painel de revenda ainda inativo.\n\nCorrigir o fluxo para que toda compra de revendedor ative automaticamente a conta e as permissões necessárias."}
                  </p>
                </div>
                <Button
                  variant="outline"
