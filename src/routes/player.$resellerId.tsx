          ...
          <div className="p-6 md:p-12 max-w-2xl mx-auto space-y-8">
            ...
            <Card className="p-6 bg-white/5 border-white/10 space-y-6">
              ...
              <div className="pt-6 border-t border-white/5 space-y-3">
                <h2 className="text-lg font-semibold">Preciso fazer uma validação completa do Web Player em ambiente real.</h2>
                <div className="p-4 bg-blue-500/10 border border-blue-500/20 rounded-lg">
                  <h4 className="text-blue-400 font-bold mb-2 flex items-center gap-2">
                    <ShieldCheck className="h-4 w-4" /> Plano de Validação em Tempo Real
                  </h4>
                  <p className="text-[10px] text-blue-200/70 leading-relaxed whitespace-pre-wrap">
                    {"Não quero apenas analisar código ou criar plano. Quero executar os testes e corrigir os problemas encontrados.\n\nTestar todas as categorias:\n\n🎬 Filmes (VOD)\n\nVerificar:\n\nLogin do usuário;\nCarregamento do catálogo;\nExibição das capas;\nAbertura dos detalhes;\nGeração da URL correta;\nReprodução do filme;\nCarregamento inicial;\nÁudio;\nVídeo;\nBusca;\nPlayer iniciando sem ficar preso em 0:00;\nRange Request (206 Partial Content);\nProxy/Core entregando os bytes corretamente.\n📺 Séries\n\nVerificar:\n\nLista de séries;\nTemporadas;\nEpisódios;\nAbertura do episódio;\nURL gerada;\nReprodução do episódio;\nPróximo episódio;\nPlayer funcionando igual aos filmes.\n📡 Canais ao vivo\n\nVerificar:\n\nLista de canais;\nCategorias;\nCarregamento do stream;\nReprodução HLS;\nTroca de canais;\nTempo para iniciar;\nTela preta;\nErros de conexão.\nDiagnóstico obrigatório:\n\nPara cada problema encontrado informar:\n\nQual categoria falhou (Filme/Série/Live);\nURL gerada;\nEndpoint utilizado;\nStatus HTTP;\nErro retornado;\nSe o problema é:\nFrontend;\nProxy;\nCore AWS;\nServidor IPTV;\nFormato de URL.\nCorreção:\n\nApós identificar:\n\nAplicar a correção diretamente no código;\nFazer deploy necessário;\nTestar novamente;\nConfirmar com evidência que:\nFilme reproduz;\nSérie reproduz;\nCanal ao vivo reproduz."}
                  </p>
                </div>
                <Button
                  variant="outline"
