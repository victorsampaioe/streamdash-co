              ...
              <div className="pt-6 border-t border-white/5 space-y-3">
                ...
                <div className="p-4 bg-yellow-500/10 border border-yellow-500/20 rounded-lg">
                  ...
                  <p className="text-xs text-yellow-200/80 leading-relaxed whitespace-pre-wrap">
                    {"Agora executar o diagnóstico no ambiente real.\n\nNão apenas criar plano. Preciso identificar qual das 4 causas está acontecendo.\n\nAo tentar reproduzir um filme/série no Web Player, registrar:\n\n1. URL gerada\n\nAntes do player iniciar:\n\n[PLAYER STREAM URL]\n\n\ncontent_id:\ntipo:\nservidor:\nURL gerada: SIM/NÃO\nformato:\n\nConfirmar se existe uma URL real de mídia.\n\n2. Testar diretamente o proxy\n\nAo chamar:\n\n/api/public/core/stream\n\nregistrar:\n\n[STREAM PROXY RESPONSE]\n\n\nHTTP status:\n200 ou 206?\nContent-Type:\nContent-Length:\nAccept-Ranges:\nErro:\n\nPara VOD preciso confirmar:\n\n206 Partial Content\n\nou suporte correto a Range.\n\n3. Verificar navegador\n\nCapturar se o navegador está recebendo:\n\narquivo de vídeo;\nmanifest .m3u8;\nsegmentos .ts;\nerro 403/404;\nerro CORS.\n4. Comparar:\n\nTestar:\n\n1 filme\n1 episódio de série\n\nInformar:\n\nFilme:\nresultado:\n\n\nSérie:\nresultado:\n\nPorque pode existir diferença na montagem:\n\nFilme:\n\nmovie/{username}/{password}/{id}.ext\n\nSérie:\n\nseries/{username}/{password}/{episode}.ext\n\nResultado esperado:\n\nNão quero apenas \"ajustamos\".\n\nPreciso:\n\nQual era a causa;\nArquivo alterado;\nLog antes/depois;\nUm filme reproduzindo no Web Player."}
                  </p>
                </div>
                <Button
                  variant="outline"
