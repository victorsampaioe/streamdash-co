              ...
              <div className="pt-6 border-t border-white/5 space-y-3">
                ...
                <div className="p-4 bg-emerald-500/10 border border-emerald-500/20 rounded-lg">
                  ...
                  <p className="text-[10px] text-emerald-200/70 leading-relaxed whitespace-pre-wrap">
                    {"# Teste completo e ajuste do Stream Monitor Play com servidor Xtream\n\nQuero validar e ajustar o Web Player usando um servidor Xtream real para garantir que todas as funções estejam funcionando.\n\nCredenciais de teste:\n\nDNS:\nhttp://newprivate.lat\n\nUsuário:\n823177668195\n\nSenha:\n165914786858\n\nTambém pode testar utilizando playlist M3U:\n\nhttp://newprivate.lat/get.php?username=823177668195&password=165914786858&type=m3u_plus&output=mpegts\n\n## Objetivo\n\nNão testar apenas o login.\n\nQuero validar o fluxo completo:\n\nLogin → carregamento do catálogo → reprodução → diagnóstico → player.\n\n---\n\n# 1. Login Xtream\n\nVerificar:\n\n* conexão com DNS;\n* HTTP/HTTPS;\n* player_api.php;\n* resposta da autenticação;\n* carregamento dos dados do usuário;\n* expiração;\n* status da conta.\n\nCaso falhe:\n\nRegistrar o erro real.\n\nNão retornar apenas:\n\n\"Não foi possível concluir a operação\".\n\nInformar internamente:\n\n* endpoint;\n* status HTTP;\n* tempo;\n* erro original.\n\n---\n\n# 2. Testar Canais ao vivo\n\nApós login:\n\nValidar:\n\n* carregamento das categorias Live TV;\n* carregamento da lista de canais;\n* imagens/logos;\n* EPG se existir;\n* reprodução do canal.\n\nTestar:\n\n* abertura do stream;\n* início da transmissão;\n* tempo até aparecer imagem;\n* erros;\n* travamentos;\n* falha HLS/TS.\n\nConfirmar:\n\n🟢 Canal abre normalmente\n\nou\n\n🔴 Canal não reproduz e informar motivo.\n\n---\n\n# 3. Testar Filmes (VOD)\n\nValidar:\n\n* categorias de filmes;\n* capas;\n* informações;\n* carregamento dos detalhes;\n* reprodução.\n\nTestar:\n\n* player iniciar;\n* carregamento do vídeo;\n* seek/avanço;\n* pausa;\n* retomada.\n\nRegistrar:\n\n* tempo inicial;\n* resposta do stream;\n* erros HTTP;\n* falha de mídia.\n\n---\n\n# 4. Testar Séries\n\nValidar:\n\n* categorias;\n* séries;\n* temporadas;\n* episódios;\n* capas;\n* detalhes.\n\nTestar:\n\n* abertura do episódio;\n* reprodução;\n* troca de episódio.\n\n---\n\n# 5. Verificar Proxy/Core\n\nComo o Web Player utiliza o Stream Monitor/Core:\n\nComparar:\n\nCliente → Stream Monitor → Core → Servidor IPTV\n\nVerificar se existe problema no:\n\n* proxy;\n* CORS;\n* headers;\n* Range;\n* HLS;\n* m3u8;\n* TS;\n* MP4;\n* MKV.\n\nRegistrar qualquer:\n\n* 403;\n* 404;\n* timeout;\n* bloqueio;\n* erro de origem.\n\n---\n\n# 6. Diagnóstico inteligente\n\nDepois dos testes, confirmar se o sistema consegue identificar:\n\n* DNS online;\n* servidor online;\n* conteúdo disponível;\n* latência;\n* estabilidade.\n\nO objetivo é que o Web Player consiga informar se um problema vem:\n\n* do servidor;\n* do conteúdo;\n* da conexão;\n* da reprodução.\n\n---\n\n# 7. Performance\n\nNão carregar todo catálogo de uma vez.\n\nGarantir:\n\n* paginação;\n* carregamento sob demanda;\n* cache;\n* carregamento progressivo.\n\nO login e abertura inicial devem continuar rápidos.\n\n---\n\n# 8. Resultado esperado do teste\n\nMe retornar um relatório:\n\n## Login\n\nStatus:\nTempo:\nErro:\n\n## Canais\n\nCarregou:\nReproduziu:\nProblemas:\n\n## Filmes\n\nCarregou:\nReproduziu:\nProblemas:\n\n## Séries\n\nCarregou:\nReproduziu:\nProblemas:\n\n## Core/Proxy\n\nStatus:\nProblema encontrado:\n\n## Correções necessárias\n\nInformar exatamente o que precisa ser ajustado para deixar o Web Player funcionando completamente.\n\nNão alterar funções que já estão funcionando em outros servidores.\n e # Testar possível bloqueio do Uniplay no Stream Monitor Play\n\nSuspeito que o problema seja bloqueio da forma como nosso Web Player acessa o Uniplay, pois existem outros Web Players que conseguem utilizar esse mesmo servidor normalmente.\n\nAntes de alterar qualquer coisa, quero identificar a diferença.\n\nFaça testes separados:\n\n### TESTE A — Acesso direto\n\nVerificar se a API Xtream do Uniplay responde diretamente ao cliente/navegador usando uma credencial válida.\n\nRegistrar:\n\n* HTTP/HTTPS;\n* status HTTP;\n* tempo;\n* resposta da API;\n* CORS;\n* erro de rede.\n\n### TESTE B — Core AWS\n\nExecutar exatamente a mesma autenticação através do Core atual:\n\n`Cliente → Stream Monitor → Core AWS → Uniplay`\n\nRegistrar:\n\n* status HTTP;\n* tempo;\n* headers relevantes;\n* timeout;\n* 403/404/5xx;\n* resposta do servidor;\n* possível bloqueio de IP/origem.\n\n### TESTE C — Servidor que funciona\n\nExecutar o mesmo fluxo do TESTE B utilizando um dos servidores que atualmente funciona no Stream Monitor Play.\n\nComparar os resultados.\n\n## Quero identificar qual cenário acontece:\n\n**A funciona + B falha**\n→ provável problema no Core/origem/IP da AWS.\n\n**A falha por CORS + B funciona**\n→ manter acesso através do Core/proxy.\n\n**A e B funcionam**\n→ problema provavelmente está no código de autenticação/processamento do Web Player.\n\n**A e B falham**\n→ investigar endpoint, protocolo, credenciais ou restrição do próprio servidor.\n\n## IMPORTANTE\n\nNão tentar contornar mecanismos de segurança ou proteção do provedor.\n\nSe houver bloqueio de IP/datacenter/WAF, identificar isso claramente para que possamos utilizar uma origem autorizada ou solicitar liberação ao provedor.\n\nTambém verificar se outros Web Players funcionam porque utilizam uma arquitetura diferente da nossa.\n\nNão alterar os servidores que já estão funcionando.\n\nNo final, me informe:\n\n* acesso direto funciona?\n* Core AWS funciona?\n* CORS permite acesso direto?\n* status HTTP direto:\n* status HTTP pelo Core:\n* existe indício de bloqueio por IP/origem?\n* qual caminho recomendado para o Stream Monitor Play?\n# Operação de ajuste completo — Stream Monitor Play\n\nQuero realizar uma operação completa para deixar o **Stream Monitor Play funcionando corretamente em todas as áreas principais**.\n\nO objetivo é garantir que o cliente consiga:\n\n✅ Fazer login normalmente\n✅ Assistir TV ao vivo\n✅ Assistir filmes\n✅ Assistir séries e episódios\n\nNão quero apenas identificar erros. Quero que seja feita uma revisão do fluxo completo e aplicar as correções necessárias.\n\n---\n\n# 1. Login e conexão Xtream\n\nValidar e ajustar:\n\n* autenticação Xtream;\n* comunicação com o servidor;\n* HTTP/HTTPS;\n* player_api;\n* resposta do usuário;\n* tratamento de erros;\n* timeout;\n* fallback.\n\nO login precisa funcionar de forma estável.\n\n---\n\n# 2. TV Ao Vivo\n\nGarantir funcionamento completo:\n\n* carregar categorias de canais;\n* carregar canais;\n* carregar logos;\n* abrir o player;\n* iniciar transmissão;\n* corrigir falhas de reprodução;\n* tratar erro de stream;\n* melhorar carregamento inicial.\n\nValidar formatos:\n\n* HLS;\n* m3u8;\n* TS;\n* outros formatos compatíveis.\n\n---\n\n# 3. Filmes (VOD)\n\nGarantir:\n\n* carregamento das categorias;\n* busca;\n* capas;\n* detalhes;\n* sinopse;\n* informações do conteúdo;\n* reprodução correta.\n\nCorrigir:\n\n* tela preta;\n* carregamento infinito;\n* erro ao iniciar vídeo;\n* problemas de Range;\n* problemas de proxy.\n\n---\n\n# 4. Séries\n\nGarantir:\n\n* lista de séries;\n* temporadas;\n* episódios;\n* capas;\n* detalhes;\n* reprodução dos episódios.\n\nCorrigir qualquer falha entre:\n\nSérie → Temporada → Episódio → Player\n\n---\n\n# 5. Player\n\nRevisar toda camada de reprodução:\n\n* HLS.js;\n* player nativo;\n* carregamento de mídia;\n* eventos de erro;\n* pause;\n* continuar reprodução;\n* avanço no vídeo;\n* tela cheia;\n* compatibilidade mobile.\n\nQuando ocorrer erro, não mostrar apenas mensagem genérica.\n\nRegistrar o motivo real:\n\n* servidor;\n* conteúdo;\n* conexão;\n* player;\n* proxy.\n\n---\n\n# 6. Core/Proxy Stream Monitor\n\nVerificar se o Core está entregando corretamente:\n\n* m3u8;\n* TS;\n* MP4;\n* MKV;\n* Range requests;\n* headers;\n* Content-Type.\n\nCorrigir qualquer problema entre:\n\nWeb Player → Core → Servidor IPTV\n\n---\n\n# 7. Performance\n\nManter o Web Player leve.\n\nNão carregar tudo de uma vez.\n\nAplicar:\n\n* lazy loading;\n* paginação;\n* carregamento sob demanda;\n* cache;\n* consultas otimizadas.\n\nO cliente deve conseguir entrar rapidamente.\n\n---\n\n# 8. Diagnóstico integrado\n\nManter preparado para utilizar:\n\n* Health Score;\n* DNS;\n* estabilidade;\n* latência;\n* incidentes.\n\nO Player deve saber diferenciar:\n\n🟢 Servidor normal\n🟡 Instabilidade\n🔴 Indisponível\n\n---\n\n# 9. Teste final obrigatório\n\nDepois das alterações, realizar teste completo:\n\n## TV Ao Vivo\n\n* login;\n* categorias;\n* abrir canal;\n* confirmar reprodução.\n\n## Filmes\n\n* abrir catálogo;\n* abrir detalhes;\n* reproduzir filme.\n\n## Séries\n\n* abrir série;\n* abrir temporada;\n* reproduzir episódio.\n\n## Mobile\n\nTestar funcionamento no celular.\n\n---\n\n# Resultado esperado\n\nEntregar o Stream Monitor Play funcionando como um Web Player completo:\n\n📺 TV Ao Vivo funcionando\n🎬 Filmes funcionando\n🍿 Séries funcionando\n▶️ Reprodução estável\n⚡ Carregamento rápido\n🧠 Diagnóstico preparado\n\nAntes de alterar arquitetura, analisar o código atual e corrigir apenas os pontos necessários para não quebrar os servidores que já funcionam."}
                  </p>
                </div>
                <Button
                  variant="outline"
