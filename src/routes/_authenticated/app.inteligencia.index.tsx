    ...
    <div className="space-y-5">
      ...
      <Dialog open={showConfirm} onOpenChange={(open) => {
        ...
        <DialogContent className="max-w-md">
          <DialogHeader>
            <DialogTitle>
              {syncProgress ? (syncProgress.processed === syncProgress.total ? "Relatório após sincronização" : "Sincronização em Progresso") : "Corrigir filtro do Radar IPTV para trabalhar somente Filmes e Séries"}
            </DialogTitle>
            <DialogDescription className="text-xs mt-2 whitespace-pre-wrap">
              {syncProgress ? (
                syncProgress.processed === syncProgress.total ? (
                  "Corrigir filtro do Radar IPTV para trabalhar somente Filmes e Séries\n\nO Radar de Conteúdo está importando conteúdos que não pertencem ao catálogo de filmes e séries, como rádios e canais ao vivo.\n\nCorrigir o processamento:\n\nIncluir somente:\n\n✅ Filmes (VOD)\n✅ Séries (Series)\n✅ Temporadas e episódios\n\nIgnorar:\n\n❌ Live TV\n❌ Rádio\n❌ Canais ao vivo\n❌ Categorias de música\n❌ Outros streams sem TMDB\n\nAntes de salvar no Radar:\n\nValidar tipo do conteúdo:\nmovie\nseries\nBuscar TMDB somente para filmes e séries.\nSalvar somente registros que tenham:\ntmdb_id válido;\nposter/capa;\ntítulo;\nano;\ntipo.\nCriar limpeza dos dados já importados:\nremover rádios;\nremover canais live;\nremover registros sem TMDB.\n\nO Radar deve mostrar apenas conteúdos com capa e informações completas. e  Limpar conteúdos inválidos já importados no Radar IPTV\n\nAlém de corrigir o filtro da sincronização, remover os conteúdos que já foram encontrados e salvos incorretamente.\n\nFazer uma limpeza no banco do Radar:\n\nRemover registros que sejam:\n\n❌ Rádio\n❌ Canais Live TV\n❌ Streams ao vivo\n❌ Categorias de música\n❌ Conteúdos sem TMDB válido\n❌ Conteúdos sem poster/capa\n❌ Conteúdos que não sejam filme ou série\n\nManter somente:\n\n✅ Filmes VOD\n✅ Séries\n✅ Temporadas\n✅ Episódios\n\nApós a limpeza:\n\nrecalcular quantidade de conteúdos encontrados;\nrecalcular primeiras detecções;\natualizar ranking;\nremover esses itens das buscas e cards do Radar.\n\nNão apagar histórico válido de filmes e séries que já possuem TMDB e primeira detecção."
                ) : (
                  "Executar limpeza definitiva do Radar IPTV (dados inválidos já salvos)\n\nA correção do filtro não removeu os conteúdos inválidos que já estavam salvos.\n\nAinda aparecem no Radar:\n\nrádios;\nstreams Live;\nconteúdos sem TMDB;\nregistros sem capa;\nregistros com rota /live/null.\n\nFazer uma limpeza real no banco:\n\nRemover todos os registros do Radar que:\n\nnão possuem tmdb_id válido;\nnão possuem poster/capa;\nnão possuem correspondência no TMDB;\nsejam Live TV;\nsejam Rádio;\nsejam canais ao vivo.\n\nManter somente:\n\n✅ Filmes VOD\n✅ Séries\n✅ Temporadas\n✅ Episódios\n\nDepois da limpeza:\n\nrecalcular total de conteúdos;\nrecalcular primeiras detecções;\natualizar ranking;\nlimpar cache do Radar.\n\nTambém corrigir o campo de tipo para não classificar rádio como \"Série\".\n\nValidar que novos conteúdos sem TMDB nunca mais entram no Radar."
                )
              ) : (
                "Corrigir filtro do Radar IPTV para trabalhar somente Filmes e Séries\n\nO Radar de Conteúdo está importando conteúdos que não pertencem ao catálogo de filmes e séries, como rádios e canais ao vivo.\n\nCorrigir o processamento:\n\nIncluir somente:\n\n✅ Filmes (VOD)\n✅ Séries (Series)\n✅ Temporadas e episódios\n\nIgnorar:\n\n❌ Live TV\n❌ Rádio\n❌ Canais ao vivo\n❌ Categorias de música\n❌ Outros streams sem TMDB\n\nAntes de salvar no Radar:\n\nValidar tipo do conteúdo:\nmovie\nseries\nBuscar TMDB somente para filmes e séries.\nSalvar somente registros que tenham:\ntmdb_id válido;\nposter/capa;\ntítulo;\nano;\ntipo.\nCriar limpeza dos dados já importados:\nremover rádios;\nremover canais live;\nremover registros sem TMDB.\n\nO Radar deve mostrar apenas conteúdos com capa e informações completas. e  Limpar conteúdos inválidos já importados no Radar IPTV\n\nAlém de corrigir o filtro da sincronização, remover os conteúdos que já foram encontrados e salvos incorretamente.\n\nFazer uma limpeza no banco do Radar:\n\nRemover registros que sejam:\n\n❌ Rádio\n❌ Canais Live TV\n❌ Streams ao vivo\n❌ Categorias de música\n❌ Conteúdos sem TMDB válido\n❌ Conteúdos sem poster/capa\n❌ Conteúdos que não sejam filme ou série\n\nManter somente:\n\n✅ Filmes VOD\n✅ Séries\n✅ Temporadas\n✅ Episódios\n\nApós a limpeza:\n\nrecalcular quantidade de conteúdos encontrados;\nrecalcular primeiras detecções;\natualizar ranking;\nremover esses itens das buscas e cards do Radar.\n\nNão apagar histórico válido de filmes e séries que já possuem TMDB e primeira detecção."
              )}
