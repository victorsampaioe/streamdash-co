            ...
            <DialogDescription className="text-xs mt-2 whitespace-pre-wrap">
              {syncProgress ? (
                syncProgress.processed === syncProgress.total ? (
                  ...
                  "O módulo \"Conteúdos Offline\" ainda está ativo e processando dados.\n\nQuero desativar completamente essa função.\n\nFazer:\n\nremover rota /app/conteudos;\nremover menu \"Conteúdos Offline\";\nremover botões de verificação;\nparar jobs/cron relacionados;\nimpedir novas análises de conteúdos offline;\nremover consultas e processamento desse módulo.\n\nNão deve consumir recursos do Core AWS.\n\nO sistema oficial agora será somente:\n\nMonitoramento DNS/HTTP/IPTV;\nRadar Inteligente de Conteúdo;\nSincronização TMDB. e Corrigir filtro da aba Filmes Recentes do Radar IPTV\n\nO problema está somente na aba Filmes recentes.\n\nEla ainda está exibindo conteúdos que não são filmes:\n\nrádios;\nlive TV;\nstreams sem TMDB;\nconteúdos sem capa.\n\nCorrigir somente essa consulta:\n\nA aba Filmes recentes deve aceitar apenas:\n\n✅ tipo = movie\n✅ VOD\n✅ tmdb_id válido\n✅ poster/capa disponível\n\nExcluir da listagem:\n\n❌ rádio\n❌ live\n❌ séries\n❌ conteúdos sem TMDB\n\nNão remover o Radar inteiro nem alterar outras abas.\n\nAplicar o mesmo filtro nas abas:\n\nFilmes populares\nPróximos lançamentos\n\nManter séries somente na aba Séries."
                )
              ) : (
                "Corrigir filtro da aba Filmes Recentes do Radar IPTV\n\nO problema está somente na aba Filmes recentes.\n\nEla ainda está exibindo conteúdos que não são filmes:\n\nrádios;\nlive TV;\nstreams sem TMDB;\nconteúdos sem capa.\n\nCorrigir somente essa consulta:\n\nA aba Filmes recentes deve aceitar apenas:\n\n✅ tipo = movie\n✅ VOD\n✅ tmdb_id válido\n✅ poster/capa disponível\n\nExcluir da listagem:\n\n❌ rádio\n❌ live\n❌ séries\n❌ conteúdos sem TMDB\n\nNão remover o Radar inteiro nem alterar outras abas.\n\nAplicar o mesmo filtro nas abas:\n\nFilmes populares\nPróximos lançamentos\n\nManter séries somente na aba Séries."
              )}
