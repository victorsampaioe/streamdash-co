...
function CreateResellerDialog({ open, onOpenChange, onDone }: { open: boolean; onOpenChange: (b: boolean) => void; onDone: () => void }) {
        ...
        <DialogHeader>
          ...
          <DialogDescription>
            {result 
              ...
              : "Preencha os dados do seu sub-revendedor para criar a conta dele."}
          </DialogDescription>
        </DialogHeader>
