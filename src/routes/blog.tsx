    ...
    <div className="min-h-screen bg-background text-foreground py-16 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid gap-8">
          {posts.map(post => (
            <a key={post.slug} href={`/blog/${post.slug}`} className="group p-6 bg-card/40 border border-border/60 rounded-2xl hover:border-primary/50 transition-all cursor-pointer block">
