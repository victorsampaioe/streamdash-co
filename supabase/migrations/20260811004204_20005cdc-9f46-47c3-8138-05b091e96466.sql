-- Remove funções existentes para garantir atualização total dos tipos de retorno
DROP FUNCTION IF EXISTS public.get_iptv_radar_stats();
DROP FUNCTION IF EXISTS public.run_radar_batch_sync();

-- Função de estatísticas com diagnóstico detalhado
...
-- Função de sincronização em lote corrigida
